...
package com.dyn.base.navigation;
...
//public class MFragmentNavigator extends Navigator<MFragmentNavigator.Destination> {
...
//
//    public MFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
//                              int containerId) {
//        mContext = context;
...
//        }
//        /**
//         * 用show  Hide 显示进行修改 2 start
//         * */
////        ft.replace(mContainerId, frag);
//        String tag = className + "_" + ((args == null) ? "null" : args.toString());
...
//            Logger.i("ShowHideFragment->%s", "hide Fragment ->" + currentFragment);
//        }
//
//        if (frag == null ||(frag!= null && frag.getView() == null)) {
//            frag = instantiateFragment(
//                    mContext, mFragmentManager,
//                    className, args
//            );
//            frag.setArguments(args);
//            Logger.i("ShowHideFragment->%s", "add Fragment tag->" + tag + " fragment->" + frag);
//            ft.add(mContainerId, frag, tag);
//        } else {
//            isShowFragment = true;
//            Logger.i("ShowHideFragment->%s", "show Fragment ->" + frag);
//            if (currentFragment != null && currentFragment.isVisible()){//这样hide show 的方式 导致栈的顺序没发生变化
//                try {
//                    MNavHostFragment.findNavController(currentFragment).popBackStack();
//                }catch (Exception e){
//                    e.printStackTrace();
//                }
//            }
...
//        if (isAdded) {
//            Logger.d("ShowHideFragment isAdded ->" + frag);
...
//
//    /**
//     * NavDestination specific to {@link MFragmentNavigator}
//     */
...
//            this(navigatorProvider.getNavigator(MFragmentNavigator.class));
//        }
//
//        /**
//         * Construct a new fragment destination. This destination is not valid until you set the
//         * Fragment via {@link #setClassName(String)}.
//         *
//         * @param fragmentNavigator The {@link MFragmentNavigator} which this destination
