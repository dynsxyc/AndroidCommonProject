 ...
 */
//public class MNavHostFragment extends Fragment implements NavHost {
...
//     * looking first for a {@link MNavHostFragment} along the given Fragment's parent chain.
...
//            if (findFragment instanceof MNavHostFragment) {
//                return ((MNavHostFragment) findFragment).getNavController();
//            }
//            Fragment primaryNavFragment = findFragment.getParentFragmentManager()
//                    .getPrimaryNavigationFragment();
//            if (primaryNavFragment instanceof MNavHostFragment) {
//                return ((MNavHostFragment) primaryNavFragment).getNavController();
//            }
...
//     */
//    @NonNull
//    public static MNavHostFragment create(@NavigationRes int graphResId) {
...
//        }
//
//        final MNavHostFragment result = new MNavHostFragment();
//        if (b != null) {
...
//     * <p>
//     * By default, this adds a {@link MFragmentNavigator}.
//     * <p>
...
//     * {@link MFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
//     * <p>
//     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
//     * subclasses.
...
//    @Deprecated
//    @NonNull
//    protected Navigator<? extends MFragmentNavigator.Destination> createFragmentNavigator() {
//        return new MFragmentNavigator(requireContext(), getChildFragmentManager(),
//                getContainerId());
//    }
//
//    @Nullable
