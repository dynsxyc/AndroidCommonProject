 ...
 * instances.
 */
final class CustomCalendarItemStyle {
  ...
  private CustomCalendarItemStyle(
  ...
  /**
   * Creates a {@link CustomCalendarItemStyle} using the provided {@link
   * R.styleable#MaterialCalendarItem}.
   */
  @NonNull
  static CustomCalendarItemStyle create(
    ...
    return new CustomCalendarItemStyle(
