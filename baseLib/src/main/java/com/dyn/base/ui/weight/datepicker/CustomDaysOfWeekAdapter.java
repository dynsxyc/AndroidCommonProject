 ...
 * @hide
 */
public class CustomDaysOfWeekAdapter extends BaseAdapter {

    @NonNull
    private final Calendar calendar = CustomUtcDates.getUtcCalendar();
     ...
     */
    public CustomDaysOfWeekAdapter() {
        firstDayOfWeek = calendar.getFirstDayOfWeek();
    }

    public CustomDaysOfWeekAdapter(int firstDayOfWeek) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (position == 0 || position == getCount() - 1) {
            dayOfWeek.setTextColor(ColorUtils.getColor(com.dyn.base.R.color.colorPrimary));
        } else {
            dayOfWeek.setTextColor(ColorUtils.getColor(com.dyn.base.R.color.text_color_99));
