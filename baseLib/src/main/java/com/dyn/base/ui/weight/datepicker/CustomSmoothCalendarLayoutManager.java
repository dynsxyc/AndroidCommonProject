 ...
 * months.
 */
public class CustomSmoothCalendarLayoutManager extends LinearLayoutManager {

  /** Default value in {@link LinearSmoothScroller} is 25f */
  private static final float MILLISECONDS_PER_INCH = 100f;

  CustomSmoothCalendarLayoutManager(Context context, int orientation, boolean reverseLayout) {
