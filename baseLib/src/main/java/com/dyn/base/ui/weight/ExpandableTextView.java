...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private boolean mCollapsed = true; // 默认收起状态

    private int mCollapsedHeight;

    private int mTextHeightWithMaxLines;

    private int mMaxCollapsedLines;//最多收起的行数
    private int mMaxExpandableLines;//最多展开的行数
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (mCollapsed){
                    ...
                    mTv.setMaxLines(mMaxExpandableLines);
                }
                // notify the listener
                if (mListener != null) {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMaxExpandableLines = typedArray.getInt(R.styleable.ExpandableTextView_maxExpandableLines, Integer.MAX_VALUE);
    ...
    private int getRealTextViewHeight(@NonNull TextView textView) {
        ...
        int textHeight = textView.getLayout().getLineTop(lineCount>mMaxExpandableLines?mMaxExpandableLines:lineCount);
