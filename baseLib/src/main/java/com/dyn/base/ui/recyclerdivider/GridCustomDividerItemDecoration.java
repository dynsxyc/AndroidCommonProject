 ...
 */
public class GridCustomDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridCustomDividerItemDecoration(Context context, @Orientation int orientation) {
    ...
    public void drawHorizontalDividers(Canvas c, RecyclerView parent) {
        final int valTop = parent.getPaddingTop();
        final int valBottom = parent.getHeight() - parent.getPaddingBottom();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            Rect dividerPadding = new Rect();
            divider.getPadding(dividerPadding);
            int top =  valTop + dividerPadding.top;
            int bottom = valBottom - dividerPadding.bottom;
