 ...
 */
class CustomUtcDates {

  static final String UTC = "UTC";

  static AtomicReference<CustomTimeSource> timeSourceRef = new AtomicReference<>();

  static void setTimeSource(@Nullable CustomTimeSource timeSource) {
    timeSourceRef.set(timeSource);
  }

  static CustomTimeSource getTimeSource() {
    CustomTimeSource timeSource = timeSourceRef.get();
    return timeSource == null ? CustomTimeSource.system() : timeSource;
  }

  private CustomUtcDates() {}
  ...
  static SimpleDateFormat getTextInputFormat() {
    ...
    format.setTimeZone(CustomUtcDates.getTimeZone());
